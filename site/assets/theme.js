(() => {
  ...
  btn.style.cssText='position:fixed;top:12px;right:12px;z-index:999;border:1px solid var(--bd);background:var(--bg2);color:var(--fg);border-radius:10px;padding:6px 10px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.12)';
  const apply = (t) => {
